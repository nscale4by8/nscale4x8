...
Thoughts About DCC               | Control                    
:----------------------------------:|:----------------------------------:
Digital Command Control (DCC) is probably great, but it's expensive. I inherited N Scale rolling stock from my father, and none of the engines support DCC. For a small layout, a Raspberry Pi (approximately $35), motor hat ($22), and a USB wifi adapter ($7) can provide excellent control for operating sessions. Of course, you need to be comfortable with small electronics projects and some computer programming to get full use of the Raspberry Pi and wifi connection. | ![](controls/IMG_0129s.png)
