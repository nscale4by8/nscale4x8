...
| 3D Printed Custom Structures - urban-industrial scenes <br /> [*New* Turret Apartments](buildingTurretApartments/buildingTurretAppartments.md) <br /> [*New* Tennessee Brewery](buildingBrew/brew.md) <br /> [Hyde Building](buildingHyde/buildingHyde.md) <br /> [Middle Building](buildingMiddle/buildingMiddle.md) <br /> [Block Building](buildingBlock/buildingBlock.md) <br /> [The Cleveland Twist Drill Co.](buildingClevelandTwistDrill/buildingCYDC.md) <br /> [The Corner Building](buildingCorner/buildingCorner.md) <br /> [Unicorn Foundry](buildingFoundry/buildingFoundry.md) <br /> ![](buildingCorner/buildingCornerAltColor_small.png) | ![](toc/tocDownStreetClose.png) ![](buildingClevelandTwistDrill/ctdc01_small.png) 
