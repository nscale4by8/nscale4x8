...
:----------------------------------:|:----------------------------------:
Digital Command Control (DCC) is probably great, but it's expensive. For a small layout, a Raspberry Pi (approximately $35), motor hat ($22), and a USB wifi adapter ($7) can provide excellent control for operating sessions. | ![](controls/IMG_0129s.png)
